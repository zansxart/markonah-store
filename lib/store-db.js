...
export const storeDB = {
    ...
    getProductsByCategory(category) {
        return stmt.getProductsByCategory.all(category).sort((a, b) => a.name.localeCompare(b.name, 'id', { sensitivity: 'base' }));
    },

    getCategories() {
        return stmt.getCategories.all().map(r => r.category).sort((a, b) => a.localeCompare(b, 'id', { sensitivity: 'base' }));
    },
